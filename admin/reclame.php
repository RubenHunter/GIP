...
//iets kunnen intyppen als boodschap, subject staat vast etc.
//automatisch naar iedereen sturen die subscribed is.
?>
<!DOCTYPE html>
<html>
<head>
...
<!-- End header -->
<div>
    <form action="sendAd.php" method="post" id="productForm">
        <table class="table notTable">
            <tr><td><label for="title">Title</label></td>
            <td><input type="text" name="title" id="title" required></td></tr>
            <tr><td><label for="message">Message</label></td>
                <td><textarea name="message" id="message" rows="5" cols="40"></textarea></td></tr>
        </table>
        <input type="submit" name="submit" value="Send" class="change">
    </form>
</div>
