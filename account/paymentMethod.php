    ...
    <div class="row">
        <div class="col-md-3 ">
            <div class="list-group ">
                ...
                <a href="paymentMethod.php" class="list-group-item list-group-item-action active">Payment Method</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="reclame.php" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-8">
                                        <h5>The payment gateway / method we use is by <a href="https://stripe.com/en-be">Stripe</a>.</h5>
                                        <h5>The payment interface is made and licensed by <a href="https://buynowplus.com/">BuyNowPlus</a>.</h5>
                                    </div>
                                </div>
                            </form>
                        </div>
