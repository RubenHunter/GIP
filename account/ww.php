...
if (isset($_POST["submit"])){
    ...
    if ($ww == $pw){
        $test = true;
            ...
            if ($account['wachtwoord'] == $ww){
                $samePW = true;
                $test = false;
            }

        if ($test){
            $sql1 = "UPDATE tblgebruikers SET wachtwoord='$ww' WHERE volgnummer=".$account["volgnummer"]." ";
    ...
    <div class="row">
        <div class="col-md-3 ">
            <div class="list-group ">
                ...
                <a href="ww.php" class="list-group-item list-group-item-action active">Change Password</a>
                        ...
                        <div class="col-md-12">
                            <form action="ww.php" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="name" name="ww" placeholder="*******" class="form-control here" type="password" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lastname" class="col-4 col-form-label">Repeat password</label>
                                    <div class="col-8">
                                        <input id="lastname" name="pw" placeholder="*******" class="form-control here" type="password" required>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group row">
                                ...
                                if (!$verWW){
                                    print "<a style='color: red'>Passwords are not the same</a><br>";
                                }
                                if ($samePW){
                                    print "<a style='color: red'>Your password is the same as you old one</a><br>";
                                }
                                ?>
                                <div class="form-group row">
