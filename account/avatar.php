...
if (isset($_POST["submit"])){
    if (isset($_FILES['foto']['name']) && $_FILES['foto']['name'] != "") {
        ...
        if (file_exists("../uploads/".$filename)){
            ...
            $query ="update tblgebruikers set profielFoto = '$filename' where volgnummer =".$account["volgnummer"];
            print $query;
            $mysqli->query($query);
    ...
    <div class="row">
        <div class="col-md-3 ">
            <div class="list-group ">
                ...
                <a href="avatar.php" class="list-group-item list-group-item-action active">Avatar</a>
                            ...
                            <form action="avatar.php" enctype="multipart/form-data" method="post">
                                <div class="">
                                    <div class="">
                                        <figure>
                                            <?php
                                            print '<img src="../uploads/' . $account["profielFoto"] . '" alt="" class="img-fluid" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">'
                                            ?>
                                        </figure>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input id="name" name="foto" class="form-control here" type="file" required>
                                    </div>
                                </div>
                                <?php
                                if ($success){
                                ...
                                <div class="form-group row">
                                    <div class="offset-4 col-8">
                                        <button name="submit" type="submit" class="btn btn-primary">Update Avatar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
